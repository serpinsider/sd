/**
 * Button Standards - San Diego Maids V4
 * 
...
export const BUTTONS = {
  ...
  serviceType: {
    ...
    selected: "ring-2 ring-[rgba(45,20,16,1)] bg-white/40 animate-glow border-[0.5px] border-white animate-selected-pulse",
...
export const BUTTON_INLINE_STYLES = {
  ...
  darkShadow: { boxShadow: '0 0 20px rgba(45, 20, 16, 0.3)' },
