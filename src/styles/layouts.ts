/**
 * Layout Standards - San Diego Maids V4
 * 
...
export const LAYOUTS = {
  ...
  card: {
    ...
    service: "bg-[rgba(30,60,45,0.9)] backdrop-blur-md rounded-xl shadow-xl border border-white/10 p-8 hover:bg-[rgba(45,20,16,0.98)] hover:shadow-2xl hover:shadow-black/30 transition-all relative flex flex-col h-full",
    
    // Review card
    review: "bg-[rgba(30,60,45,0.9)] backdrop-blur-md rounded-xl p-6 shadow-xl border border-white/10 hover:bg-[rgba(45,20,16,0.98)] hover:shadow-2xl hover:shadow-black/30 transition-all",
