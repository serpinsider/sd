...
export const metadata: Metadata = {
  title: 'Refund & Cancellation Policy - San Diego Maids',
  description: 'Our satisfaction guarantee and cancellation policy. We make it right if the clean isn\'t to your standard. 24-hour cancellation notice required.',
  openGraph: {
    title: 'Refund & Cancellation Policy - San Diego Maids',
    description: 'Our satisfaction guarantee and cancellation policy for house cleaning services.',
    url: 'https://sandiegomaids.com/refund',
  ...
  alternates: {
    canonical: 'https://sandiegomaids.com/refund',
  },
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">Satisfaction Guarantee</h2>
          ...
          {/* Cancellation Policy */}
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">Cancellation Policy</h2>
            <div className="space-y-4 text-white/80">
          ...
          {/* How to Contact Us */}
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">How to Contact Us for Refunds or Issues</h2>
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span>Call us: {CONTACT_INFO.phone.display}</span>
                </a>

                <a 
                  href={CONTACT_INFO.phone.href.replace('tel:', 'sms:')} 
                  className="flex items-center space-x-3 text-white/80 hover:text-white transition-colors"
                >
                  <svg className="w-5 h-5 text-[#dfbd69]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
                  <span>Text us: {CONTACT_INFO.phone.display}</span>
                </a>
                ...
                >
                  ...
                  <span>Email us: {CONTACT_INFO.email.display}</span>
                </a>
              </div>
