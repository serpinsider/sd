...
export const metadata: Metadata = {
  title: 'Cleaning Services - San Diego Maids',
  description: 'Professional cleaning services in San Diego. Deep cleaning, move-out cleaning, Airbnb cleaning, carpet cleaning, handyman services, and more.',
  openGraph: {
    title: 'Cleaning Services - San Diego Maids',
    description: 'Professional cleaning services in San Diego. Deep cleaning, move-out cleaning, Airbnb cleaning, carpet cleaning, and more.',
    url: 'https://sandiegomaids.com/services',
  ...
  twitter: {
    ...
    title: 'Cleaning Services - San Diego Maids',
    description: 'Professional cleaning services in San Diego. Deep cleaning, move-out cleaning, Airbnb cleaning, and more.',
    images: ['/ogs-image.jpg'],
  },
  alternates: {
    canonical: 'https://sandiegomaids.com/services',
  },
};
