...
export const metadata: Metadata = {
  title: 'Terms of Service & Agreement - San Diego Maids',
  description: 'Our terms of service, service agreement, payment terms, and liability policies for house cleaning services in San Diego.',
  openGraph: {
    title: 'Terms of Service - San Diego Maids',
    description: 'Our terms of service, service agreement, and policies for house cleaning services in San Diego.',
    url: 'https://sandiegomaids.com/terms',
  ...
  alternates: {
    canonical: 'https://sandiegomaids.com/terms',
  },
};

export default function TermsOfService() {
  return (
    <main className="pt-48 pb-16 px-4" style={{ background: 'rgba(26, 55, 85, 0.95)' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">Service Agreement</h2>
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">Our Commitment</h2>
            <div className="space-y-4 text-white/80">
              <p>We commit to:</p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">Service Limitations</h2>
            <div className="space-y-4 text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">Payment Terms</h2>
            <div className="space-y-4 text-white/80">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">Liability and Insurance</h2>
            <div className="space-y-4 text-white/80">
              <p>San Diego Maids is fully insured and bonded. However:</p>
              <ul className="list-disc pl-6 space-y-2">
          ...
          <section className="mb-12">
            <h2 className="text-xl font-semibold text-[#dfbd69] mb-6">Service Areas</h2>
            <div className="space-y-4 text-white/80">
              <p>We currently serve San Diego County, including:</p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Coastal: La Jolla, Pacific Beach, Mission Beach, Ocean Beach, Point Loma, Coronado, Del Mar, Solana Beach</li>
                <li>North County: Encinitas, Carlsbad, Oceanside, San Marcos, Vista, Escondido, Rancho Santa Fe</li>
                <li>Central & East: San Diego, Hillcrest, North Park, Carmel Valley, Scripps Ranch, Poway, El Cajon, La Mesa</li>
                <li>South: Chula Vista, National City, Santee, Lakeside</li>
              </ul>
            </div>
          </section>
