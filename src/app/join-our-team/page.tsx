...
export default function JoinOurTeamPage() {
  ...
  return (
    <div className="min-h-screen pt-48 pb-12" style={{ background: 'rgba(26, 55, 85, 0.95)' }}>
        ...
        <div className="backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/10" style={{ background: 'rgba(20, 25, 30, 0.5)' }}>
          ...
          <div className="bg-white/10 rounded-lg p-6 mb-8 border border-white/20">
            ...
            <ul className="text-sm text-white/80 space-y-1">
              ...
              <li>• Work in beautiful homes across San Diego County</li>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  placeholder="ex. Jane"
                  className="w-full p-3 border border-white/20 rounded-lg bg-[#1a1f24]/50 text-white placeholder-white/50 focus:border-[#dfbd69] focus:ring-1 focus:ring-[#dfbd69]"
            ...
            <div>
              ...
              <select
                ...
                className="w-full p-3 border border-white/20 rounded-lg bg-[#1a1f24]/50 text-white appearance-none focus:border-[#dfbd69] focus:ring-1 focus:ring-[#dfbd69]"
              >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 border border-white/20 rounded-lg bg-[#1a1f24]/50 text-white placeholder-white/50 focus:border-[#dfbd69] focus:ring-1 focus:ring-[#dfbd69] h-32 resize-none"
            ...
            <p className="text-xs text-white/60 text-center mt-4 leading-relaxed">
              By submitting this form, you agree to receive communications from San Diego Maids regarding your application.
              <br />
