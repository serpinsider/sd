...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://sandiegomaids.com'
  ...
  const serviceQuotePages = [
    'carpet-cleaning', 'handyman', 'commercial', 'airbnb', 'post-construction', 'car-cleaning',
  ].map((service) => ({
  ...
  return [...staticPages, ...locationPages, ...servicePages, ...additionalServicePages, ...serviceQuotePages]
}