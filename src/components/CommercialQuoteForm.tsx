...
export default function CommercialQuoteForm() {
  ...
  const handleSubmit = async () => {
    ...
    const confirmNum = 'PC-COMM-' + Math.random().toString(36).substring(2, 8).toUpperCase();
    ...
    try {
      const response = await fetch('https://formspree.io/f/mrbjzvde', {
        ...
        body: JSON.stringify({
          ...
          _subject: `San Diego Maids - Commercial Quote from ${formData.firstName} ${formData.lastName} - #${confirmNum}`,
