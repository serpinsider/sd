...
const commercialReviews = [
  ...
  },
  {
    id: 2,
    name: "Patricia L.",
    location: "San Diego Medical",
    rating: 5,
    text: "We run a dental practice and cleanliness is critical. San Diego Maids understands medical-grade cleaning. Highly professional team!",
    date: "2 weeks ago",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-sm sm:text-base text-white/70 max-w-3xl mx-auto">
            Trusted by California businesses for reliable commercial cleaning.
          </p>
        </div>
