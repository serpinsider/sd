  ...
  const handleSubmit = async (retryCount = 0) => {
    ...
    try {
      ...
      const formspreeData = {
        ...
        _subject: `San Diego Maids - Quote Request from ${formData.firstName} ${formData.lastName}`,
        ...
        return (
          <div className="space-y-6">
            ...
            <p className="text-[10px] sm:text-xs text-white/60 text-center leading-relaxed">
              By submitting, you agree to receive communications from San Diego Maids regarding your quote request.
            </p>
          </div>
        );
