...
export default function FAQSection({ location = "San Diego" }: FAQSectionProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, San Diego Maids is fully insured and bonded for your peace of mind.\n\nAll our housekeepers are background-checked and trained. We carry comprehensive liability insurance to protect your home and belongings."
    },
    {
      question: "What areas do you service?",
      answer: "**San Diego County:**\n• Coastal: La Jolla, Pacific Beach, Mission Beach, Ocean Beach, Point Loma, Coronado, Del Mar, Solana Beach\n• North County: Encinitas, Carlsbad, Oceanside, San Marcos, Vista, Escondido, Rancho Santa Fe\n• Central: San Diego, Hillcrest, North Park, Mission Hills, Carmel Valley, Scripps Ranch, Poway, Rancho Bernardo\n• South & East: Chula Vista, National City, El Cajon, La Mesa, Santee, Lakeside\n\n**Zip Codes Served:**\n• San Diego: 92101-92199, 91910-91950\n\nContact us to confirm service in your area."
    },
    {
      question: "How do I schedule a cleaning?",
      answer: "Get a quote or book online, or contact us directly:\n\n• Call: <a href='tel:+18585446420' class='text-[#dfbd69] hover:text-[#dfbd69]/80 font-semibold'>(858) 544-6420</a>\n• Text: <a href='sms:+18585446420' class='text-[#dfbd69] hover:text-[#dfbd69]/80 font-semibold'>(858) 544-6420</a>\n\nWe offer same-day and next-day service when available.\n\nContact us if you have questions about cleaning or handyman services.\n\n<div class='flex flex-col sm:flex-row gap-3 mt-4'><a href='/quote' class='bg-[#dfbd69] text-slate-900 px-6 py-3 rounded-lg font-semibold text-center hover:bg-[#dfbd69]/90 transition-colors'>Get A Quote</a></div>"
    },
    {
