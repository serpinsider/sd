...
export default function CarpetQuoteForm() {
  ...
  const handleSubmit = async () => {
    ...
    const confirmNum = 'PC-CARPET-' + Math.random().toString(36).substring(2, 8).toUpperCase();
    ...
    try {
      const response = await fetch('https://formspree.io/f/mrbjzvde', {
        ...
        body: JSON.stringify({
          ...
          _subject: `San Diego Maids - Carpet Cleaning Quote from ${formData.firstName} ${formData.lastName} - #${confirmNum}`,
        ...
        <div className="lg:col-span-2 backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/10" style={{ background: getFormBg() }}>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input type="text" placeholder="90001" value={formData.zipCode} onChange={(e) => setFormData({ ...formData, zipCode: e.target.value.replace(/\D/g, '').slice(0, 5) })} maxLength={5}
