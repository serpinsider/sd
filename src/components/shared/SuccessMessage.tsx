        ...
        <div className="text-center space-y-5">
          <div className="animate-fade-in">
            ...
            <p className="text-white/90 text-base sm:text-lg">
              {type === 'booking' ? "Your booking request has been submitted successfully." : serviceLabel ? `We'll be in touch about your ${serviceLabel} request.` : "We've saved your information to make booking easier."}
            </p>
          </div>
            ...
            {type === 'quote' ? (
              <>
                <p className="text-white text-sm leading-relaxed">
                  ...
                  {serviceLabel ? `A team member will reach out shortly to discuss your ${serviceLabel} needs and provide a custom quote.` : <>You&apos;ll receive a quote via text in about 60 seconds<br /><br />A team member will follow up to answer questions and help you schedule using your saved details.</>}
                </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            ...
            <button
              ...
              className="flex-1 bg-[#dfbd69] text-[#142d23] py-3 px-6 rounded-lg hover:bg-[#dfbd69]/90 font-semibold transition-all duration-300 hover:-translate-y-[1px]"
            >
              Get Another Quote
            </button>
          </div>
