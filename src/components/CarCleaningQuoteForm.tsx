...
export default function CarCleaningQuoteForm() {
  ...
  const handleSubmit = async () => {
    ...
    const confirmNum = 'PC-CAR-' + Math.random().toString(36).substring(2, 8).toUpperCase();
    ...
    try {
      const response = await fetch('https://formspree.io/f/mrbjzvde', {
        ...
        body: JSON.stringify({
          ...
          _subject: `San Diego Maids - Car Detailing Quote from ${formData.firstName} ${formData.lastName} - #${confirmNum}`,
