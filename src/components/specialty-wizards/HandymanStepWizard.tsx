...
export default function HandymanStepWizard({ onFormExpand }: HandymanStepWizardProps) {
  ...
  if (currentStep === 4) return <SuccessMessage type="quote" confirmationNumber={formData.confirmationNumber} inline={true} onClose={handleCloseSuccess} serviceLabel="handyman services" />;
