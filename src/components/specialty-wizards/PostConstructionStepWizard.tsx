...
export default function PostConstructionStepWizard({ onFormExpand }: PostConstructionStepWizardProps) {
  ...
  if (currentStep === 4) return <SuccessMessage type="quote" confirmationNumber={formData.confirmationNumber} inline={true} onClose={handleCloseSuccess} serviceLabel="post-construction cleaning" />;
