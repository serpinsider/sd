        ...
        <div className="flex gap-4 mt-8">
          ...
          {currentStep === 4 ? (
            <button onClick={handleSubmit} disabled={!canProceed() || isSubmitting}
              className={`${currentStep === 1 ? 'w-full' : 'flex-1'} p-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2 ${canProceed() && !isSubmitting ? 'bg-[#dfbd69] text-[#283845] hover:bg-[#dfbd69]/90 hover:-translate-y-[1px]' : 'bg-white/20 text-white/50 cursor-not-allowed'}`}>
            ...
            <button onClick={nextStep} disabled={!canProceed()}
              className={`${currentStep === 1 ? 'w-full' : 'flex-1'} p-3 rounded-lg font-semibold transition-all duration-300 ${canProceed() ? 'bg-[#dfbd69] text-[#283845] hover:bg-[#dfbd69]/90 hover:-translate-y-[1px]' : 'bg-white/20 text-white/50 cursor-not-allowed'}`}>
              Continue
            </button>
          )}
        </div>
