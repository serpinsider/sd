...
export default function HandymanQuoteForm() {
  ...
  const handleSubmit = async () => {
    ...
    const confirmNum = 'PC-HANDY-' + Math.random().toString(36).substring(2, 8).toUpperCase();
    ...
    try {
      const response = await fetch('https://formspree.io/f/mrbjzvde', {
        ...
        body: JSON.stringify({
          ...
          _subject: `San Diego Maids - Handyman Quote from ${formData.firstName} ${formData.lastName} - #${confirmNum}`,
