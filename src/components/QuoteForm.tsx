...
export default function QuoteForm() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const confirmationNumber = 'PC-' + Math.random().toString(36).substring(2, 8).toUpperCase();
      ...
      const response = await fetch('https://formspree.io/f/xvzwolek', {
        ...
        body: JSON.stringify({
          ...cleanFormData,
          _subject: `San Diego Maids - Quote Request from ${formData.firstName} ${formData.lastName} - #${confirmationNumber}`,
        ...
        <div className="lg:col-span-2 backdrop-blur-md p-8 rounded-xl shadow-xl border border-white/10" style={{ background: getFormBg() }}>
          ...
          <div className="space-y-6">
            ...
            <p className="text-xs text-white/60 text-center mb-4 mt-8">
              By submitting this form, you agree to receive communications from San Diego Maids regarding your quote request.
            </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-white/70 leading-relaxed">
                        We serve all of San Diego County -- La Jolla, Pacific Beach, Carlsbad, Encinitas, Chula Vista, Coronado, Del Mar, and surrounding areas. Contact us to confirm service in your area.
                      </p>
                    </div>
